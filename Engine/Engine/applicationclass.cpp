...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->InitializeTerrain(m_Direct3D->GetDevice(), 128, 128, L"../Engine/data/grass.dds", L"../Engine/data/slope.dds", L"../Engine/data/rock.dds");   //initialise the flat terrain.
	if(!result)
	{
	...
	m_Light->SetDirection(0.75f, -0.25f, 0.0f);
	...
	m_RenderTexture = new RenderToTexClass;
	if (!m_RenderTexture)
	{
		return false;
	}
	...
	m_DownSampleTexture = new RenderToTexClass;
	...
	result = m_DownSampleTexture->Initialize(m_Direct3D->GetDevice(), downSampleWidth, downSampleHeight, SCREEN_DEPTH, SCREEN_NEAR);
	if (!result)
	{
	...
	m_HorizontalBlurTexture = new RenderToTexClass;
	...
	m_VerticalBlurTexture = new RenderToTexClass;
	...
	m_UpSampleTexture = new RenderToTexClass;
	...
	m_FullScreenWindow = new OrthoClass;
...
bool ApplicationClass::HandleInput(float frameTime)
{
	...
	m_Terrain->CollisionDetection(m_Direct3D->GetDevice(), keyDown, m_Camera->GetPosition());
	m_Position->MoveDownward(keyDown, m_Terrain->GetMove());
